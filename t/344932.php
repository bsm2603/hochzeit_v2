...
<div class="popup" id="hint">
    <h2>Hinweis</h2>
    <p>Islandpferde sind dafür bekannt, dass sie den Tölt beherrschen. Nicht vergessen zur richtigen Lösung noch 8 zu addieren.</p>
...
<div class="popup" id="guess">
    ...
    <div id="guessCorrect">
        ...
        <p><strong>Genieß die Party an, um oder auf Tisch 13.</strong></p>
    </div>
    <p id="guessWrong">Das ist leider noch nicht korrekt. Checke noch mal den Hinweis und rechne nach.</p>
    <input type="button" value="OK" onclick="checkSolution(13)" />
</div>

<div class="popup" id="tell">
    <h2>Die korrekte Lösung</h2>
    <p>Islandpferde können außer den normalen Gangarten noch passen und tölten. Man nennt sie deshalb auch 5-Gänger.<br /><br />Zähle zur 5 noch 8 hinzu und Du kommst auf 13.</p>
    <p><strong>Deine Tischnummer ist die 13.</strong></p>
...
<p style="margin-top: 20px; text-align:center"><strong>So findest Du Deine Tischnummer:</strong><br/>
    Wie viele Gangarten kann ein Islandpferd? Rechne zum Ergebnis 8 hinzu.<br /><br />
