 	...
 	<div class="easy-sticky-sidebar-container">
 		<div id="SSuprydp_builder_form">
 			<div class="SSuprydp_col_2 SSuprydp-form-col">
 				<form id="SSuprydp_form" method="post" action="<?php echo add_query_arg('action', 'process_pages', admin_url('admin-ajax.php')) ?>" <?php echo implode(' ', $form_attributes)  ?>>
 					<input type="hidden" id="ajaxaction" value="<?php echo add_query_arg('action', 'ajax_check', admin_url('admin-ajax.php')); ?>" />
 					...
 					<div class="SSuprydp_page_fields">
 						...
 						<div class="SSuprydp_field_wrap cta-name-field">
 							...
 							<input type="text" name="sidebar_name" class="SSuprydp_input" value="<?php echo esc_attr($stickycta->sidebar_name); ?>" placeholder="Enter CTA name here">
 						</div>
 			...
 			<?php if (!has_wordpress_cta_pro()) : ?>
 				<div class="wordpress-cta-advertisement"><a href="https://wpctapro.com/" target="_blank"><img src="<?php echo EASY_STICKY_SIDEBAR_PLUGIN_URL; ?>/assets/img/ads.png" /></a></div>
 			<?php endif; ?>
 		</div>
 	</div>
 </div>
